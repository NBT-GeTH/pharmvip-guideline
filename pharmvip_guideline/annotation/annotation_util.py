...
def  not_found_guide(summary_and_full_report:pd.DataFrame,guidline_info:InfoConstruction,diplotype,drug_set):
    ...
    temp = {
            ...
            "cpi_sum_population" : 'general',
            "cpi_sum_act_score1" : '',
            "cpi_sum_act_score2" : '',
            "cpi_sum_act_score3" : '',
            "cpi_sum_strength": "N/A",
            "cpi_sum_recommendations": "<text>No recommendation.</text></br>",
            "cpi_sum_recommendations_full": "<text>No recommendation.</text></br>",
...
def  handle_warfarin(summary_and_full_report, diplotypes:pd.DataFrame):
    ...
    warfarin_recommendations_full = "<text>From genotype info, please follow the flowchart to determine the appropriate dosing recommendation for warfarin.<br/><br/><text><strong>Dosing recommendations for Warfarin dosing based on genotype for adult patients</strong></text><br/><br/><center><img src='https://s3.pgkb.org/attachment/CPIC_warfarin_2017_Fig_2.png' width='500px' height='329px'></center><br/></text></br>"
