...
import sys
sample_path = pack_path + '/../resources/samples/HS10227/'
vcf_path = sample_path + 'HS10227_final.vcf.gz'
diplotype_cyp2d6_path = sample_path + 'HS10227_diplotype_CYP2D6.tsv'
diplotype_hla_path = sample_path + 'HS10227_diplotype_hla.tsv'
